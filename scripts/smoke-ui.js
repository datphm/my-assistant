...
try {
  ...
  if (!getElement('assistantGateDisplay').innerHTML.includes('DISPLAY AT GATE') || !getElement('assistantGateDisplay').innerHTML.includes('VN999') || !getElement('assistantGateDisplay').innerHTML.includes('gate-status departed') || !getElement('assistantBrief').innerHTML.trim().startsWith('<section class="assistant-top-grid')) throw new Error('Active flight was not pinned in the colored Assistant gate display');
