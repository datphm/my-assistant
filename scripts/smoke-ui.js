...
try {
  ...
  if (!getElement('assistantGateDisplay').innerHTML.includes('DISPLAY AT GATE') || !getElement('assistantGateDisplay').innerHTML.includes('Ho Chi Minh City') || !getElement('assistantBrief').innerHTML.trim().startsWith('<section class="assistant-top-grid')) throw new Error('Compact top Assistant gate display did not render');
